...
class DbcParser(object):
    ...
    def msg_hdl(self, line):
        ...
        try:
            self._current_msg = CoreModel.CanMsg(int(reg.group('msg_id')), reg.group('msg_name'),
    ...
    def signal_hdl(self, line):
        ...
        try:
            self._current_signal = CoreModel.CanSignal(reg.group('name'), int(reg.group('start_bit')),
